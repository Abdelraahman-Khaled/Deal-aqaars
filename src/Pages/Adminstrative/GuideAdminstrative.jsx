...
const GuideAdminstrative = ({ title }) => {
  ...
  const fetchProperties = async (page) => {
    try {
      setLoading(true);
      const response = await AdministrativeAPI.getAllAdministrative(page);
...
export default GuideAdminstrative;
