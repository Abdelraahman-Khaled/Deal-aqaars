...
const UpdateFactory = () => {
    ...
    useEffect(() => {
        const fetchProperty = async () => {
            setIsLoading(true);
            try {
                const response = await PropertyAPI.getFactoryById(id);
    ...
    return (
        <>
            <HelmetInfo
                titlePage={
                    currentLanguage === "ar" ? "تعديل الوحدة الصناعية" : "Update Factory"
                }
            />
                                ...
                                <div className="w-100">
                                    <div className="pb-4">
                                        <BreadcrumbsPage
                                            ...
                                            mainTitle={"تعديل الوحدة الصناعية"}
                                    ...
                                    <p className="b-1 mb-2 pb-3 ">تعديل الوحدة الصناعية</p>
                                    ...
                                    >
                                        <div className="d-flex text-center flex-column align-items-center justify-content-center w-100 space-4 p-5">
                                            ...
                                            <p className="b-15" style={{ color: "var(--netural-700)" }}>
                                                تمام،تم تحديث الوحدة الصناعية بنجاح، في انتظار الموافقة! ✨ هنراجع
