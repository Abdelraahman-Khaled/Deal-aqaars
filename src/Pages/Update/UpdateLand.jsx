...
const UpdateLand = () => {
    ...
    useEffect(() => {
        const fetchProperty = async () => {
            setIsLoading(true);
            try {
                const response = await PropertyAPI.getLandById(id);
    ...
    const handleSubmit = async (values, { resetForm }) => {
        ...
        console.log("--- Submitting Update Land Data ---");
        ...
        try {
            const response = await PropertyAPI.updateLand(id, formData);
    ...
    return (
        <>
            <HelmetInfo
                titlePage={
                    currentLanguage === "ar" ? "تعديل الأرض" : "Update Land"
                }
            />
                        ...
                        <ContainerMedia>
                            <div className="form-container finishing align-items-center px-0">
                                <div className="w-100">
                                    ...
                                    <p className="b-1 mb-2 pb-3 ">تعديل الأرض</p>
                                    ...
                                    >
                                        <div className="d-flex text-center flex-column align-items-center justify-content-center w-100 space-4 p-5">
                                            ...
                                            <p className="b-15" style={{ color: "var(--netural-700)" }}>
                                                تمام،تم تحديث الأرض بنجاح، في انتظار الموافقة! ✨ هنراجع
